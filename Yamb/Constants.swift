...
let purchaseDiamondsId = "yamb.PurchaseDiamondsNewOne"

let allPurchaseIds: Set<String> = [purchaseNameId, purchaseDiamondsId, purchaseDiceGId, purchaseDiceLId, purchaseDicePId, purchaseDiceZId, purchaseDiceXId]
